...
func (WorkHistory) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Float("freelancer_earnings").SchemaType(map[string]string{dialect.Postgres: "DECIMAL"}),
		field.Time("start_date"),
		field.Time("end_date").Optional(),
		field.String("description"),
		field.Float("budget").SchemaType(map[string]string{dialect.Postgres: "DECIMAL"}),
