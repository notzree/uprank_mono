...
class SQSQueue(Queue):
    ...
    def __init__(self, sqs_client: SQSClient, ranker_queue_url: str, notification_queue_url: str) -> None:
        super().__init__()
    ...
    def send_ranking_response(self, ranking_response: Any) -> None:
        self.sqs_client.send_message(
            QueueUrl=self.ranker_queue_url, MessageBody="ur mom",
        )
